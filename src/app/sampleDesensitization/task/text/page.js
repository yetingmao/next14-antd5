...
export default function () {
            ...
            render: (text, record) => {
                ...
                const details =
                    <Button
                        type="link"
                        onClick={() => {
                            router.push(`/sampleDesensitization/taskDetails?id=${record["id"]}`)
                        }}
                    >详情</Button>
                const edit = <Button
                    type="link"
    ...
    async function getParameter() {
        ...
        res = await getModelList({ modelType: 1, pageNum: 1, pageSize: 100 });
        if (res?.code == 200) {
