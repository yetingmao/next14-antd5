...
import { getSampleListImg, getTagTree, delSampleList } from "@/api";
...
export default function () {
  ...
  async function getList() {
    setLoading(true);
    const res = await getSampleListImg({
      ...queryParams,
  ...
  async function del() {
    ...
    const res = await delSampleList({ assetImgIds: ids });
    if (res?.code == 200) {
                  ...
                  >
                    {dataList.map((item, index) => (
                      <Card
                        ...
                        style={{ width: 200, margin: 5, height: 300 }}
                      >
                        <Card.Meta
                          description={
                            <>
