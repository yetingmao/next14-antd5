...
export default function deviceDetail() {
    ...
    const [taskQuery, setTaskQuery] = useState({ status: "", taskType: 3 })
            ...
            <div key={index} style={{ display: "flex", background: "rgb(240, 242, 245)", marginTop: "5px" }}>
                ...
                {item.childFiles ? item.childFiles.map((item, index) => (
                    <Card
                        size="small"
                        hoverable={true}
                        title={<Checkbox value={item.fileId}>扩充后图</Checkbox>}
                        extra={<Button type="link" icon={<DownloadOutlined onClick={() => {
                            const a = document.createElement("a");
                            a.href = item.fileUrl;
                        ...
                        >
                            ...
                            >
                                <Descriptions bordered>
                                    ...
                                    <Descriptions.Item label="扩充路径">{detail.tagResults ? detail.tagResults.join(",") : "暂无"}</Descriptions.Item>
                                    ...
                                    <Descriptions.Item label="开始扩充时间">{detail.startTime || "暂无"}</Descriptions.Item>
                                    <Descriptions.Item label="结束扩充时间">{detail.endTime || "暂无"}</Descriptions.Item>
                                    <Descriptions.Item label="创建人">{detail.creatUser || "暂无"}</Descriptions.Item>
